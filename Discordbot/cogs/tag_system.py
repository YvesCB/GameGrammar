...
class TagSystem(commands.Cog, name='Tag system'):
    ...
    @commands.command(name='tag_remove', aliases=['t_remove'], help='Alliases: `!t_remove`\nRemove an existing tag.\nCan only be used by admins!\nUsage: `!tag_remove/!t_remove <name>`')
    @bot_tools.is_admin()
