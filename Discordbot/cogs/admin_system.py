...
class AdminRoleSystem(commands.Cog, name='Admin role system'):
    ...
    @commands.command(name='admins', aliases=['a'], help='Alliases: `!a`\nShows a list of all current admin roles.\nUsage: `!admins/!a`')
    @commands.guild_only()
