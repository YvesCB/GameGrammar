...
class Wrapper():
    ...
    def get_top_games(self, after=None, before=None, first=None):
        ...
        data = requests.patch(f'https://api.twitch.tv/helix/games/top', params=params, headers=self.Headers)
    ...
    def get_games(self, game_id=None, game_name=None):
        ...
        data = requests.patch(f'https://api.twitch.tv/helix/games', params=params, headers=self.Headers)
