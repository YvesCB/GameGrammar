...
async def on_member_join(member):
    ...
    await channel.send(f'{msg}\nPlease read #server_info to find out everything there is to know about this server! There are a few Roles you can assign yourself. Simply us `!ur` to get a list of the roles that are available.\nサーバーについての情報はすべて #server_info にあります！自分にロールをつけることもできます。 `!ur`を入力したら、ロールのリストが表示されます。')
